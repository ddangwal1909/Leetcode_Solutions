...
<div class="snipit-button extension-button" data-sig="cbfbb421f2083698d8a387da289d4c3d" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><ul style="margin-top: 0px;">
...
<div class="snipit-button extension-button" data-sig="daaaebc63f3584db8c2242de063b434b" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><pre style="margin-top: 0px;"><strong>Input</strong>
...
<div class="snipit-button extension-button" data-sig="b82dd75cb38edd53580a6390fd8b2a44" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><ul style="margin-top: 0px;">
