...
<div class="snipit-button extension-button" data-sig="44a56743686cbb1e762c996e385f39f4" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><pre style="margin-top: 0px;">+-------------+---------+
| Column Name | Type    |
+-------------+---------+
| person_id   | int     |
| person_name | varchar |
...
<div class="snipit-button extension-button" data-sig="346c78fa0342abc600da0594ffdf7173" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><pre style="margin-top: 0px;"><strong>Input:</strong> 
Queue table:
+-----------+-------------+--------+------+
