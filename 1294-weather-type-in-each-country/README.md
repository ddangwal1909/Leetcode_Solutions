...
<div class="snipit-button extension-button" data-sig="2a4e4b378b6ff38e777298d19b88215e" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><pre style="margin-top: 0px;">+---------------+---------+
| Column Name   | Type    |
+---------------+---------+
| country_id    | int     |
...
<div class="snipit-button extension-button" data-sig="23c9cdba79a972ce211bc41f73be80d7" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><pre style="margin-top: 0px;">+---------------+------+
| Column Name   | Type |
+---------------+------+
| country_id    | int  |
| weather_state | int  |
...
<div class="snipit-button extension-button" data-sig="1b3be632a420d37ecc0e753bbf3b17fc" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><ul style="margin-top: 0px;">
...
<div class="snipit-button extension-button" data-sig="5cab90f69d99ac676515760e6b4d4fd1" style="border-bottom: 0px; border-radius: 3px 3px 0px 0px; padding-bottom: 2px;">{ Snip }</div><pre style="margin-top: 0px;"><strong>Input:</strong> 
Countries table:
+------------+--------------+
